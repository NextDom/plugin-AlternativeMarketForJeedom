    ...
    $.post({
        ...
        data: {
            ...
            // Version de l'installation par URL
                update: '{"logicalId":"' + currentPlugin['id'] + '","configuration":{"url":"https://github.com/' + currentPlugin['gitId'] + '/' + currentPlugin['gitName'] + '/archive/' + branch + '.zip"},"source":"url"}'
            // Version de l'installation par GitHub
            //update: '{"logicalId":"' + currentPlugin['id'] + '","configuration":{"user":"' + currentPlugin['gitId'] + '", "repository":"'+ currentPlugin['repository'] +'", "version":"'+ branch +'"},"source":"github"}'
